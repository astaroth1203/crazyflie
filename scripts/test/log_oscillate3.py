...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  5 18:41:49 2018
        ...
        with SyncLogger(scf, lg_stab) as logger:
            ...
            for log_entry in logger:
                ...
                if rise==False:
                    ...
                    if check_epsilon(data['stateEstimate.z']-defaultz,height,epsilon):
                        print('Risen')
                        rise = True
                ...
                if rise:
                    if j==0:
                        cf.commander.send_hover_setpoint(0.5,0,0,height)
...
#                            j=0
            ...
            plt.title('StateEstimate.x Data: kp=%f ki=%f kd=%f' % (kp,ki,kd))
            plt.show()
            #cf.param.set_value("flightmode.althold","False")
            print('Done')
            cf.close_link()
